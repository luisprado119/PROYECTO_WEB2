          ...
          <TableBody>
            {order.Details.map((detail) => (
              <TableRow key={detail.ProductID}>
                ...
                <TableCell><ProductPrice eurAmount={detail.UnitPrice} /></TableCell>
                <TableCell>{detail.Quantity}</TableCell>
                <TableCell>{(detail.Discount * 100).toFixed(0)}%</TableCell>
                <TableCell><ProductPrice eurAmount={detail.UnitPrice * detail.Quantity * (1 - detail.Discount)} /></TableCell>
              </TableRow>
            ))}
          </TableBody>
        </Table>
        <h3 className="text-lg font-semibold">
          Importe total: <ProductPrice eurAmount={order.TotalAmount} />
        </h3>
